...
import 'package:capitron_new/screens/home_screen/account2_top.dart';
import 'package:flutter/material.dart';

import '../../constants.dart';
import 'account_status.dart';

class HomeAccount2 extends StatefulWidget {
  @override
  _HomeAccount2State createState() => _HomeAccount2State();
}

class _HomeAccount2State extends State<HomeAccount2> {
  // Some bools
  ...
  Widget header(BuildContext context) {
    return Expanded(flex: 1, child: Account2Top());
  }
